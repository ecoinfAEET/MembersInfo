...
Miembros del [grupo de Ecoinformática](http://www.aeet.org/EcoInformatica_383_p.htm) de la [Asociación Española de Ecología Terrestre (AEET)](http://www.aeet.org/). Para darte de alta rellena tus datos [aquí](https://docs.google.com/forms/d/e/1FAIpQLScCIlXvN2LtOkj1MNFPK-UzTfkK8jg5ZMXT0OgjyUUJdndo2Q/viewform?c=0&w=1).
...
print_member <- function(member) {
  ...
  cat("![](", paste0("https://twitter.com/", tw.handle, "/profile_image?size=normal"), "){width=250px}\n", sep = "")
  ...
  cat("\n[Web]() ", #member$`Pagina web`, ") ", 
      "[Twitter](https://twitter.com/", tw.handle, ") ", 
      "[GitHub](https://github.com/", member$`Cuenta de GitHub`, ")\n\n", sep = "")
